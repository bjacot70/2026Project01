...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/wdgst:Area | wdgst:Body | wdgst:Content | wdgst:Dialog | wdgst:MessageBox | wdgst:Page | wdgst:Scrollbar | wdgst:StartupProgressBar | wdgst:Tooltip | wdgst:Focus | wdgst:ElementFocus | wdgst:ModalDimmer | wdgst:ChangePasswordDialog | wdgst:SystemLogin | wdgst:TableConfigurationDialog | wdgst:Selection">
